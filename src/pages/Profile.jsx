...
export default function Profile() {
    ...
    const [files, setFiles] = useState([]); // Инициализация состояния для файла аватара

    const {
        control, // Извлечение control для использования в Controller
        register,
        handleSubmit,
        resetField,
    ...
    const doSubmit = async values => {
        try {
            // Загрузка аватара при его наличии
            if (files.length > 0) {
